export const veriqEscrowCommitAbi = [
  { type: "function", name: "submitResultCommitment", stateMutability: "nonpayable", inputs: [{ name: "jobId", type: "uint256" }, { name: "resultCommitment", type: "bytes32" }], outputs: [] },
  {
  ...
  { type: "event", name: "ResultCommitted", anonymous: false, inputs: [{ indexed: true, name: "jobId", type: "uint256" }, { indexed: true, name: "provider", type: "address" }] },
] as const;
